...
|---|---|---|---|
| R0 无 | 4.11% / −25.3% / 0.16 | 2.32% / −16.2% / 0.14 | −8.4% / −7.6% |
| **R1 现行（200 日线 / 波动 / 回撤）** | 2.90% / −18.2% / 0.16 | 1.48% / −18.4% / 0.08 | −3.8% / −6.1% |
| R2 新分界：熊市停开新仓 | 3.20% / −19.7% / 0.16 | 1.76% / −17.6% / 0.10 | −6.7% / −6.1% |
| R3 R2 + 宣布熊市清仓 | 3.14% / −20.1% / 0.16 | 1.97% / −17.9% / 0.11 | −6.9% / −6.0% |
| R4 R2 + R1 | 3.15% / −15.7% / 0.20 | 1.34% / −18.4% / 0.07 | −3.7% / −6.1% |
...
注意：20 年回测用 2026-09 时点的成分股，幸存者偏差很大，只看方案之间的相对差异；美股突破策略 20 年年化只有 1.5～2.3%，问题不在熊市，而在策略在美股的优势本身很弱。
...
`python run.py sim-tier show` 查看，`python run.py sim-tier aggressive` 切换（只改 `var/sim.json`）。
...
- 美股 SPYM 与 VOO 差 0.1pp/年（平局，按 Calmar 取 SPYM；小账户下 SPYM 单价低、零头资金少）。
